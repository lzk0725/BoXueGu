...
//获取界面控件并处理相关控件的点击事件
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(originalPsw)) {
                    ...
                    Toast.makeText(ModifyPswActivity.this, "两次输入密码不一致",
                            Toast.LENGTH_SHORT).show();
                    return;
                }else{
    ...
    private void modifyPsw(String newPsw) {
        ...
        SharedPreferences sp = getSharedPreferences("loginInfo",MODE_PRIVATE);//loginInfo是sp的文件名
        SharedPreferences.Editor editor = sp.edit();//获取sp的编辑器
        editor.putString(userName,md5Psw);//userName作为key，密码作为value
        editor.commit();//提交修改
    }
